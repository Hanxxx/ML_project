...
public class multiforage3  extends ControlSystemMFN150
	{
	...
	public static double dir3 = -Math.PI/2; 
	public static Vec2 position_3;
	...
	private long	seed=637;			// random number seed
	...
	public void configure()
		...
		fangxiang = new wojiade3(1.0,0.0,SquiggleBallSim.SquiggleBalldircection);
		...
		*/
		...
		if (multiforage0.oncespotted == 1)
		{
			...
			if(remain != in_what_state)
			{
		        ...
		        {
		        	dir3 = person_to_SquiggleBall.t;
		        }
		        if (prefered_action==1)
		        {
		        	dir3 = person_to_SquiggleBall.t + (Math.PI/4);
		        }
		        ...
		        {
		        	dir3 = person_to_SquiggleBall.t + (Math.PI/2);
		        }
		...
		position_3 = SquiggleBall.Value(curr_time);
