...
public class multiforage_s3  extends ControlSystemMFN150
	{
	...
	public static double dir3_s = Math.PI/2; 
	public static Vec2 position_3_s;
	...
	private long	seed=123;			// random number seed
	...
	public void configure()
		...
		fangxiang = new wojiade_s3(1.0,0.0,SquiggleBallSim.SquiggleBalldircection);
	...
	public int takeStep()
		...
		if (multiforage_s.oncespotted_s == 1)
		{
			...
			if(remain != in_what_state)
			{
		        ...
		        {
		        	dir3_s = person_to_SquiggleBall.t;
		        }
		        if (prefered_action==1)
		        {
		        	dir3_s = person_to_SquiggleBall.t + (Math.PI/4);
		        }
		        ...
		        {
		        	dir3_s = person_to_SquiggleBall.t + (Math.PI/2);
		        }
		...
		position_3_s = SquiggleBall.Value(curr_time);
