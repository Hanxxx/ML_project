...
public class multiforage_s1  extends ControlSystemMFN150
	{
	...
	public static double dir1_s = Math.PI/2; 
	public static Vec2 position_1_s;
	...
	private long	seed=798;			// random number seed
	...
	public void configure()
		...
		fangxiang = new wojiade_s1(1.0,0.0,SquiggleBallSim.SquiggleBalldircection);
	...
	public int takeStep()
		...
		judg =0;
		//multiforage_s.weibu = 0;
		multiforage_s.judge_s = 0;
		...
		if (multiforage_s.oncespotted_s == 1)
		{
			...
			if(remain != in_what_state)
			{
		        ...
		        {
		        	dir1_s = person_to_SquiggleBall.t;
		        }
		        if (prefered_action==1)
		        {
		        	dir1_s = person_to_SquiggleBall.t + (Math.PI/4);
		        }
		        ...
		        {
		        	dir1_s = person_to_SquiggleBall.t + (Math.PI/2);
		        }
		...
		multiforage_s.SquiggleBall_direction_s = SquiggleBall.Value(curr_time);
		position_1_s = SquiggleBall.Value(curr_time);
		
		 if (PF_TARGET0_VISIBLE_takestep.intValue(curr_time)==1)
		 {
			 multiforage_s.judge_s = 1;
		 }
		...
		else if (state == 1)
		{
			...
			multiforage_s.oncespotted_s = 1;
		}
		else if (state == 2)
		{
			abstract_robot.setDisplayString("deliver");
			multiforage_s.judge_s = 2;
		}
