...
public class multiforage  extends ControlSystemMFN150
	{
	...
	public void configure()
		...
		// avoid obstacles
		NodeVec2
		MS_AVOID_OBSTACLES = new v_Avoid_va(0.5,//原来是1.5
			abstract_robot.RADIUS + 0.01,
			PS_OBS);

		// swirl obstacles wrt target 0
		NodeVec2
		MS_SWIRL_OBSTACLES_TARGET0 = new v_Swirl_vav(0.5,//原来2.0
