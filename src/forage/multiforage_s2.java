...
public class multiforage_s2  extends ControlSystemMFN150
	{
	...
	public static double dir2_s = Math.PI/2; 
	public static Vec2 position_2_s;
	...
	private long	seed=456;			// random number seed
	...
	public void configure()
		...
		fangxiang = new wojiade_s2(1.0,0.0,SquiggleBallSim.SquiggleBalldircection);
	...
	public int takeStep()
		...
		if (multiforage_s.oncespotted_s == 1)
		{
			...
			if(remain != in_what_state)
			{
		        ...
		        {
		        	dir2_s = person_to_SquiggleBall.t;
		        }
		        if (prefered_action==1)
		        {
		        	dir2_s = person_to_SquiggleBall.t + (Math.PI/4);
		        }
		        ...
		        {
		        	dir2_s = person_to_SquiggleBall.t + (Math.PI/2);
		        }
		...
		position_2_s = SquiggleBall.Value(curr_time);
