...
public class multiforage0  extends ControlSystemMFN150
	{
	...
	public static int oncespotted = 0;
	private NodeVec2 fangxiang;
	public static double dir = 0; 
	public static Vec2 position_0;
	public static int weibu;
	public static double q_310_0;
	public static double q_310_1;
	public static double q_310_2;
	public static double q_310_3;
	public static double q_310_4;
	//=======================================================================
	...
	public void configure()
		...
		fangxiang = new wojiade(1.0,0.0,SquiggleBallSim.SquiggleBalldircection);
		...
		//将Q值表写入文件
		//======================================================================
        File file = new File("d:\\Q3_origin.txt"); 
		FileWriter out = null;
		try {
	...
	public int takeStep()
		...
		if (curr_time >100)
		{
			...
			/*
			Vec2 AB = new Vec2(mulitiforage0.position_0.x-multiforage1.position_1.x,multiforage0.position_0.y-multiforage1.position_1.y);
		...
		*/
		...
		if (multiforage0.oncespotted == 1)
		{
			...
			if(remain != in_what_state)
			{
		        ...
		        {
		        	dir = person_to_SquiggleBall.t;
		        }
		        if (prefered_action==1)
		        {
		        	dir = person_to_SquiggleBall.t + (Math.PI/4);
		        }
		        ...
		        {
		        	dir = person_to_SquiggleBall.t + (Math.PI/2);
		        }
		    ...
		    //设定奖赏函数
		        ...
		        if (Math.abs(ABS+BCS+ACS-ABC)<=0.0001)
		        {
		            ...
		            if ((theta_max>0) && (theta_max<(Math.PI/3)))
		            {
			    ...
			    **/
		        ...
		        rn_now = 2*J + rn1;//Math.abs(person_to_SquiggleBall.r)/dis_sum;//下一时刻的立即奖赏
		...
		SquiggleBall_direction = SquiggleBall.Value(curr_time);
		position_0 = SquiggleBall.Value(curr_time);
		
		 //System.out.println(oncespotted);
		 //一但发现目标则turret朝着目标
