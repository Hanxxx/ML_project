...
public class multiforage1  extends ControlSystemMFN150
	{
	...
	public static double dir1 = Math.PI/2; 
	public static Vec2 position_1;
	...
	private long	seed=365;			// random number seed
	...
	public void configure()
		...
		fangxiang = new wojiade1(1.0,0.0,SquiggleBallSim.SquiggleBalldircection);
		...
		*/
		...
		if (multiforage0.oncespotted == 1)
		{
			...
			if(remain != in_what_state)
			{
		        ...
		        {
		        	dir1 = person_to_SquiggleBall.t;
		        }
		        if (prefered_action==1)
		        {
		        	dir1 = person_to_SquiggleBall.t + (Math.PI/4);
		        }
		        ...
		        {
		        	dir1 = person_to_SquiggleBall.t + (Math.PI/2);
		        }
		...
		position_1 = SquiggleBall.Value(curr_time);
