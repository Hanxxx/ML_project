...
public class wojiade_s2 extends NodeVec2
	...
	*/
	public wojiade_s2(double czr, double dzr,
		Vec2 im1)
		{
		embedded1 = im1;
		controlled_zone = czr;
	...
	*/
	public Vec2 Value(long timestamp)
		...
		if ((timestamp > lasttime)||(timestamp == -1))
			...
			/*--- set the vector ---*/
			goal.setr(mag);
			goal.sett(multiforage_s2.dir2_s);
			last_val = goal;
			}
		if (DEBUG) System.out.println(last_val.r+" "+goal.r);
		Vec2 asd = new Vec2(last_val.x, last_val.y);
		return (asd);
		}
        }
