...
import forage.multiforage0;
import forage.multiforage_s;
...
public class SimulationCanvas extends Canvas implements Runnable
	...
	public static int zero = 2;//我加的
	public static Vec2[] SquiggleBall;//我加的
	...
	*/
	...
	public void run()
		...
		SquiggleBall = new Vec2[4];//改这里
		judgement = new int[4];//改这里
		while (keep_running)
			{
			cishu = trials;
			//if (sim_time > 100000)
			...
			for(int i=0; i<control_systems.length; i++)
				{
				int stat = control_systems[i].takeStep();//进入forage的入口,从forage返回也再次在此
				//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
				//记得改这里！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
				//SquiggleBall[i] = multiforage0.SquiggleBall_direction; //改控制策略
				//judgement[i] = multiforage0.judge;                     //改控制策略
				//真正的是上面两句
				//SquiggleBall[i] = multiforage_s.SquiggleBall_direction_s; //改控制策略
				//judgement[i] = multiforage_s.judge_s;                     //改控制策略
				if (stat!=ControlSystemS.CSSTAT_DONE)
					robots_done = false;
				}

			/*--- run the physics ---*///从Simple进入和返回的入口
			...
			if (((timeout>0)&&(sim_time>=timeout))
				|| robots_done)//||AttractorSim.jieshu)//||multiforage0.weibu)
				{
				if (trials <= 1)
					{
					for (int i = 0; 
					...
					//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
				/*
					File file1 = new File("d:\\weibulv.txt"); //这里也要改
					FileWriter out = null;
					try {
						...
						e.printStackTrace();
						    ...
						    try {
								out.write(501-trials +"\t");
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
						    try {
								out.write(multiforage0.weibu +"\t");
						    	//out.write(multiforage_s.weibu_s +"\t");//注意这里也要改
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
						    //try {
								//out.write(sim_time/1000 +"\t");
							//} catch (IOException e) {
								// TODO Auto-generated catch block
								//e.printStackTrace();
							//}
						    try {
								out.write(multiforage0.q_310_0 +"\t");
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
						    try {
								out.write(multiforage0.q_310_1 +"\t");
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
						    try {
								out.write(multiforage0.q_310_2 +"\t");
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
						    try {
								out.write(multiforage0.q_310_3 +"\t");
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
						    try {
								out.write(multiforage0.q_310_4 +"\t");
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
